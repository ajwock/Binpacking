...
/**
 * A ChangeStack should have a List<List<Changes>> or similar. It is an item
 * that can change itself take in and apply a list of changes to itself as a
 * "stack frame" and then revert those changes when that frame is popped.
 * 
 * @author Andrew Wock
 *
 */
